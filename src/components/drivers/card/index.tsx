...
const DriverCard: FC<Props> = ({ driver, onUpdated }) => {
  ...
  return (
    <div className='bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow'>
